...
type = ["Vinyasa Yoga", "Hatha Yoga", "Iyengar Yoga", "Kundalini Yoga", "Ashtanga Yoga", "Bikram Yoga", "Yin Yoga", "Restorative Yoga", "Prenatal Yoga", "Anusara Yoga", "Jivamukti Yoga"]
